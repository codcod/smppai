...
from smppai.experiment.log import setup_logging
...
def handle_deliver_sm(pdu: command.DeliverSM):
    ...
    #   pdu.short_message=b'id:Smsc2108 sub:1 dlvrd:1 submit date:2311011357 done
    #                       date:2311011357 stat:DELIVRD err:0 text:Hi 1000'
    #   pdu.sm_length=101
    #   pdu.data_coding=3
